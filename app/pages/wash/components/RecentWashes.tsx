...
export default function RecentWashes({ washes }: Props) {
  return (
    <section style={{ marginTop: 30 }}>
      <h3 style={{ fontSize: "var(--h3-size)", fontWeight: 800, margin: "20px 0 px" }}>Seneste vaske</h3>
      <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
        {washes.map((wash, i) => (
          ...
          >
            ...
            <span style={{ background: "#18de84", color: "#fff", fontSize: 12, fontWeight: 700, padding: "3px 8px" }}>{wash.plan}</span>
          </li>
        ))}
      </ul>
    </section>
